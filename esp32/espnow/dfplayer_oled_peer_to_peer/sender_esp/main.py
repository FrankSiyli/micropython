...
while True:
    ...
    if current_button_state != last_button_state:
        if current_button_state == 0:  # Corrected line
            message = "makeItHappen"
            esp.send(peer, message)
            print("Message sent:", message)  # Print when message is sent

        # Update the last button state
        last_button_state = current_button_state


# receiver    08:3A:8D:9A:41:D0 b'\x08:\x8d\x9aA\xd0'
# sender  08:3A:8D:9A:48:30 b'\x08:\x8d\x9aH0'
